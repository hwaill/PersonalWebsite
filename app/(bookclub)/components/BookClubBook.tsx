			...
			{book &&
				<div className={style.bookClubBookPageContent}>
					...
					<div className={style.bookClubBookPageText}>
						<div className={style.bookClubBookPageTextTitle}>{book.title}</div>
						...
						<div className={style.bookClubBookPageTextRating}>
							{book.inProgress ?
								...
								<span><span className={style.bookClubBookPageTextRatingNumber}>{book.averageRating.toFixed(2)}</span> out of 7 Club Rating</span>
							}
						</div>
						{book.inProgress ?
							<></> : 
							<>
								<div className={style.bookClubBookPageTextMemberRatingsTitle}>Member Ratings</div>
										...
										return (
											<Link href={"/bookclub/members/member?id=" + item.member.id} className={style.bookClubBookPageTextMemberRating} key={index}>
												...
												<div className={style.bookClubBookPageTextMemberText}>
													...
													<div className={style.bookClubBookPageTextMemberTextRating}><span>{item.value}</span> out of 7</div>
												</div>
											</Link>
										)
									})}
