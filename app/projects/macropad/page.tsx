	...
	return (
		<>
			...
			<video controls preload="meta" className={style.videoPlayer}>
				<source src="https://www.itsshreeyo.com/hwhosting/macropadVideo.mp4" type="video/mp4" />
			</video>
			...
			<p>Without easy access to advanced soldering tools like a reflow oven, I opted to have <em>JLCPCB</em> assembe most of the components onto the board. The only remaining soldering was of the rotary encoders and the hot-swap sockets. In what felt like a miraculous turn of events, all five boards turned on without a hiccup!</p>
			<div className={style.clearFix}></div>
			<h4>The Enclosure</h4>
